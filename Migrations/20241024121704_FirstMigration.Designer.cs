...
namespace CarRent.Migrations
{
    ...
    [Migration("20241024121704_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRent.Models.CarImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CarRent.Models.Booking", b =>
                {
                    ...
                    b.HasOne("CarRent.Models.ApplicationUser", "User")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CarRent.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
